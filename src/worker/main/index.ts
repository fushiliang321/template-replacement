...
type allMethodNames = methodKeys<ReplaceInterface> | "getWasmUrl"

const allowCallMethodNames: Set<allMethodNames> = new Set(["sign", "getWasmUrl"])
...
export default class WorkerReplace implements ReplaceInterface {
  ...
  async getWasmUrl(): Promise<string> {
    return ""
  }
}
